class PatientController < ApplicationController
  ...
  def create
   ...
   # @patient = current_user.patients.build(patient_params)
    if @patient.save
      redirect_to user_index_path, notice: "Patient created successfully !!! "
    else
      redirect_to user_index_path, notice: "Patient was not created !!! "
    end
  end
  ...
  def update
    if current_user.role_id == 1
      ...
      if @patient.update(patient_params)
        redirect_to user_index_path, notice: "Patient was edited successfully !!! "
      else
  ...
  def destroy
    if current_user.role_id == 1
      ...
      respond_to do |format|
        format.html {redirect_to user_index_path, notice: 'Patient was successfully destroyed.'}
